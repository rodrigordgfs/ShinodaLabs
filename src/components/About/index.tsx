  ...
  return (
    <section id="about" className="py-24 bg-zinc-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-r from-teal-500/10 to-lime-500/10 rounded-full filter blur-3xl"></div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            <div className="relative group">
              <div className="relative z-10 bg-gradient-to-br from-zinc-800/50 to-zinc-900/50 backdrop-blur-xl rounded-3xl p-8 border border-teal-500/20 hover:border-teal-400/40 transition-all duration-500">
                <div className="w-40 h-40 mx-auto mb-6 bg-gradient-to-br from-teal-500/20 to-lime-500/20 rounded-3xl flex items-center justify-center text-4xl font-bold border border-teal-500/30 relative overflow-hidden">
                  <span className="bg-gradient-to-r from-teal-400 to-lime-500 bg-clip-text text-transparent">DEV</span>
                  <div className="absolute inset-0 bg-gradient-to-r from-teal-500/10 to-lime-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-teal-500/20 to-lime-500/20 rounded-3xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-500"></div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                {['React', 'Vue.js', 'Next.js', 'Nuxt.js', 'TypeScript', 'Node.js'].map((tech) => (
                  <span
                    key={tech}
                    className="px-4 py-2 bg-gradient-to-r from-zinc-800/50 to-zinc-900/50 border border-teal-500/20 rounded-xl text-teal-300 text-sm hover:bg-gradient-to-r hover:from-teal-500/10 hover:to-lime-500/10 hover:border-teal-400/40 hover:text-teal-200 transition-all duration-300 backdrop-blur-sm"
                  >
                    {tech}
                  </span>
                ))}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {highlights.map((item, index) => (
              ...
              >
                ...
                <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-teal-500/10 to-lime-500/10 rounded-full filter blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              </div>
            ))}
          </div>
        </div>
