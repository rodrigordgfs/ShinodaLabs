...
import { Heart, ArrowUp, Zap, Code, Github, Linkedin, Instagram, Twitter, Mail, Phone, MapPin, Rocket, Star } from 'lucide-react';
...
const Footer = () => {
  ...
  return (
    <footer className="bg-zinc-950 relative overflow-hidden">
      ...
      <div className="w-full h-px bg-gradient-to-r from-transparent via-teal-500/50 to-transparent"></div>
            ...
            <div className="lg:col-span-2">
              <div className="mb-8">
                <div className="text-3xl font-bold mb-4 flex items-center gap-3">
                  ...
                  <span className="text-teal-400 animate-pulse">/&gt;</span>
                  <Code className="w-6 h-6 text-teal-400/50" />
                </div>
                <p className="text-zinc-400 text-lg leading-relaxed max-w-md">
                  Desenvolvedor Full Stack especializado em criar 
                  <span className="text-teal-400"> experiências digitais excepcionais</span> usando 
              ...
              <div className="space-y-4">
                ...
                {contactInfo.map((contact, index) => (
                  <div key={index} className="cursor-pointer flex items-center gap-3 text-zinc-400 hover:text-teal-400 transition-colors duration-300 group">
              ...
              <div className="flex gap-3 mb-6">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    title={social.label}
                  >
                    <social.icon className="w-4 h-4 text-zinc-400 group-hover:text-teal-400 transition-colors duration-300" />
                    <div className="absolute inset-0 bg-gradient-to-r from-teal-500/20 to-emerald-500/20 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur"></div>
                  </a>
                ))}
              </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-4">
                ...
                >
                  ...
                  <ArrowUp className="relative w-4 h-4 text-zinc-400 group-hover:text-teal-400 transition-colors duration-300" />
                </button>
              </div>
            </div>
          </div>
