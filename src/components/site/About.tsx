      ...
      <div className="relative mx-auto max-w-6xl px-5 grid lg:grid-cols-12 gap-16 items-center">
        ...
        >
          <div className="relative rounded-3xl overflow-hidden card-premium aspect-[4/5]">
            ...
            <div className="absolute bottom-5 left-5 right-5">
              <div className="font-display text-xl text-foreground">Fundador</div>
        ...
        >
          ...
          <h2 className="font-display text-4xl sm:text-5xl font-semibold leading-tight text-foreground">
            Um estúdio focado no que <span className="text-gradient">poucos olham</span>:
            o detalhe.
          </h2>
          <p className="mt-6 text-muted-foreground leading-relaxed">
            Construo produtos digitais há quase uma década, unindo a precisão da
            engenharia com a sensibilidade do design. Cada pixel, cada milissegundo,
            cada microinteração — tudo é parte da experiência. Trabalho lado a lado
            com fundadores e times de produto que valorizam excelência.
          </p>
          <p className="mt-4 text-muted-foreground leading-relaxed">
            Acredito em código limpo, design tokens, sistemas escaláveis e em entregar
            algo que pareça inevitável: o tipo de produto que faz o cliente dizer
          ...
          <div className="mt-10 grid sm:grid-cols-2 gap-3">
            {skills.map((s) => (
              <div
                key={s.label}
                className="card-premium rounded-xl p-4 flex items-start gap-3"
              >
